      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm text-dark-300 font-medium mb-2"
                    >
                      Full Name
                    </label>
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-xl glass border-white/10 bg-white/5 text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-all text-sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl glass border-white/10 bg-[#0f172a] text-white focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-all text-sm"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 rounded-xl glass border-white/10 bg-white/5 text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-all text-sm resize-none"
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="w-full h-full bg-gradient-to-br from-primary-600/10 to-dark-800/50 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-4xl mb-2">🗺️</div>
                  <p className="text-dark-400 text-sm">Map Placeholder</p>
