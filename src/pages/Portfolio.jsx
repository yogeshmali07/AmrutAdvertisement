...
import { SectionHeading, GlassCard, Modal, Button } from '../components/ui';
            ...
            {filteredItems.map((item, i) => (
              ...
              >
                <div
                  ...
                  className="group cursor-pointer glass rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-primary-600/10 transition-all duration-300"
                >
